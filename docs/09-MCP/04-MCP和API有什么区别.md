...
- [上一篇：MCP Tools、Resources、Prompts 是什么](./03-MCP工具资源和提示是什么.md)
- [下一篇：MCP 和 Function Calling 有什么区别](./05-MCP和Function-Calling有什么区别.md)
- [相关：API 是什么](../06-工具与Function-Calling/01-API到底是什么.md)
