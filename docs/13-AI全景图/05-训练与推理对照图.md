...
flowchart LR
    ...
    click Loss "../03-模型原理与训练/18-训练和推理有什么区别.md"
    click Backward "../03-模型原理与训练/18-训练和推理有什么区别.md"
    click Optimizer "../03-模型原理与训练/18-训练和推理有什么区别.md"
    ...
    click Select "../03-模型原理与训练/18-训练和推理有什么区别.md"
...
继续对照：[模型生命周期图](./04-模型生命周期图.md) · [参数到底是什么](../03-模型原理与训练/06-参数到底是什么.md) · [知识网络](../../知识网络.md)
